...
# 
# knn_model <- preProcess(test, "knnImpute") ## this does not impute values for the class variable?
# test<- predict(knn_model, test)
...
test <- RF_with_Nulls(train,test,"PH",.5,5,10,.008,5,1)
...
p <- ggplot(train, aes(x=Mnf.Flow, y=PH)) +
  geom_point(shape=1) +    # Use hollow circles
  geom_smooth()   
